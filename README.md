...
<body>
    ...
    <p> After researching the success of subway solutions, we realized that partnering with the MTA is a project inhibitor. We thought we were developing a product that served the customer segment of 18-45 year old business-oriented subway commuters; however, we traintracked was a smart device that we would have to sell to the MTA. In consequence, we decided to pivot toward another, less obvious problem that surfaced during our longer customer interviews.</p>
